...
test_data = np.genfromtxt(open("../data/test.csv"), delimiter=',', skip_header=1, usecols=(1, 4, 5, 6, 7, 9, 11), converters={4: sex, 11: embarked})
...
nn = MLPClassifier(hidden_layer_sizes=(20, 20, 20, 20, 20), solver="sgd", max_iter=2500)
...
conf_matrix = confusion_matrix(train_y, pred)
print(conf_matrix)
